 ...
 */
export type ToolHookEvent = "PreToolUse" | "PostToolUse" | "PostToolUseFailure" | "PermissionRequest";
/**
 * Simple hook events that don't require matchers
 */
export type SimpleHookEvent = "UserPromptSubmit" | "Notification" | "Stop" | "SubagentStop" | "PreCompact" | "SessionStart" | "SessionEnd";
/**
 ...
 */
export declare const PROMPT_ARGUMENTS_PLACEHOLDER = "$ARGUMENTS";
/**
 * Events that support prompt-based hooks:
 * PreToolUse, PostToolUse, PostToolUseFailure, PermissionRequest,
 * UserPromptSubmit, Stop, SubagentStop
 */
export declare const PROMPT_HOOK_SUPPORTED_EVENTS: Set<HookEvent>;
/**
 * Type guard to check if an event supports prompt hooks
 */
export declare function supportsPromptHooks(event: HookEvent): boolean;
/**
 ...
 */
export declare function isCommandHook(hook: HookCommand): hook is CommandHookConfig;
/**
 * Type guard to check if a hook is a prompt hook
 */
export declare function isPromptHook(hook: HookCommand): hook is PromptHookConfig;
/**
 ...
 */
export declare const TOOL_EVENTS: Set<HookEvent>;
/**
 * Type guard to check if an event is a tool event
 */
export declare function isToolEvent(event: HookEvent): event is ToolHookEvent;
/**
 * Exit codes from hook execution
 */
export declare enum HookExitCode {
 ...
 */
export type HookInput = PreToolUseHookInput | PostToolUseHookInput | PostToolUseFailureHookInput | PermissionRequestHookInput | UserPromptSubmitHookInput | NotificationHookInput | StopHookInput | SubagentStopHookInput | PreCompactHookInput | SessionStartHookInput | SessionEndHookInput;
