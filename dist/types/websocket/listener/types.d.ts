...
import type { DequeuedBatch, QueueBlockedReason, QueueItem, QueueRuntime } from "../../queue/queue-runtime";
import type { SharedReminderState } from "../../reminders/state";
import type { ToolsetName, ToolsetPreference } from "../../tools/toolset";
import type { ApprovalResponseBody, ClientToolsetConfig, ControlRequest, ExternalToolCallResult, LoopStatus, RuntimeScope, StopReasonType, WsProtocolCommand } from "../../types/protocol_v2";
import type { ServiceCommandRequest, ServiceCommandResponse } from "../../types/service-protocol";
...
export interface StartListenerOptions {
    ...
    onRetrying?: (attempt: number, maxAttempts: number, nextRetryIn: number, connectionId: string) => void;
    onWsEvent?: (direction: "send" | "recv", label: "client" | "protocol" | "control" | "lifecycle", event: unknown) => void;
}
...
export type ProcessQueuedTurn = (queuedTurn: IncomingMessage, dequeuedBatch: DequeuedBatch) => Promise<void>;
/**
...
export type ListenerStreamObserver = (message: ObservedProtocolV2Message) => void;
...
export type InboundMessagePayload = (MessageCreate & {
    client_message_id?: string;
}) | ApprovalCreate;
...
export type ListenerRuntime = {
    ...
    serviceCommandHandler: ((command: ServiceCommandRequest) => Promise<ServiceCommandResponse>) | null;
    ...
    permissionModeByConversation: Map<string, import("./permission-mode").ConversationPermissionModeState>;
    ...
    worktreeWatcherByConversation: Map<string, import("./worktree-watcher").WorktreeWatcherState>;
     ...
     */
    agentMetadataByAgent: Map<string, Promise<{
        name: string | null;
