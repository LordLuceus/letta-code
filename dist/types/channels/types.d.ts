 ...
 */
import type { WhatsAppMessagePrefixConfig } from "./whatsapp/message-prefix-config-types";
...
export interface WhatsAppChannelConfig extends WhatsAppAttachmentPolicyConfig, WhatsAppMessagePrefixConfig {
    channel: "whatsapp";
    enabled: boolean;
    dmPolicy: DmPolicy;
    allowedUsers: string[];
...
export interface WhatsAppChannelAccount extends ChannelAccountBase, WhatsAppAttachmentPolicyConfig, WhatsAppMessagePrefixConfig {
    channel: "whatsapp";
    /** Agent ID used for account-bound DM and group auto-routing. */
    agentId: string | null;
