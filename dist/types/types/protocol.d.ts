 ...
 */
export type QueueItemSource = "user" | "task_notification" | "cron" | "channel" | "subagent" | "system";
/**
 ...
 */
export type QueueItemKind = "message" | "task_notification" | "cron_prompt" | "approval_result" | "overlay_action" | "mod_continue";
/**
 ...
 */
export interface QueueSnapshotItem extends Omit<Partial<QueueRuntimeItemWire>, "kind" | "source"> {
...
export type SdkToCliControlRequest = {
    ...
    subtype: "interrupt";
} | RegisterExternalToolsRequest | BootstrapSessionStateRequest | RecoverPendingApprovalsControlRequest | ListMessagesControlRequest;
/**
...
export type ControlResponseBody = {
    subtype: "success";
    request_id: string;
    response?: CanUseToolResponse | RecoverPendingApprovalsResponsePayload | Record<string, unknown>;
} | {
    subtype: "error";
    request_id: string;
    error: string;
 ...
 */
export type WireMessage = SystemMessage | ContentMessage | MessageWire | StreamEvent | ApprovalRequestedMessage | ApprovalReceivedMessage | ToolExecutionStartedMessage | ToolExecutionFinishedMessage | AutoApprovalMessage | CancelAckMessage | ErrorMessage | RetryMessage | RecoveryMessage | ResultMessage | ControlResponse | ControlRequest | QueueLifecycleEvent | TranscriptBackfillMessage | QueueSnapshotMessage | SyncCompleteMessage | TranscriptSupplementMessage;
