 ...
 */
export type PiProviderModelRegistration = Omit<Model<Api>, "api" | "provider" | "baseUrl"> & {
    api?: Api;
    baseUrl?: string;
};
...
export interface PiProviderOAuthLoginCallbacks extends Omit<OAuthLoginCallbacks, "onDeviceCode"> {
    onDeviceCode?: (info: PiProviderOAuthDeviceCodeInfo) => void;
}
export interface PiProviderOAuthConfig {
    name?: string;
    login: (callbacks: PiProviderOAuthLoginCallbacks) => Promise<OAuthCredentials>;
...
export interface PiProviderRegistration {
    ...
    listModels?: (connection: PiProviderConnection) => Promise<PiProviderModelRegistration[]> | PiProviderModelRegistration[];
...
//# sourceMappingURL=pi-provider-mod-types.d.ts.map